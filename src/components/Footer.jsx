...
<footer className="bg-white dark:bg-gray-900">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0 flex flex-col items-start justify-center w-[350px] h-[189px]">
            <div>
            <a href="https://flowbite.com/" className="flex items-center">
                  <img src={url} width={84} height={44} alt="Reslink Logo" />
                  <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Reslink</span>
              </a>
                </div>
              <div classNameName='flex flex-col items-start justify-center text-[#FEFEFE]'>
                <p>Copyright © 2023 Reslink.</p>
                <p>All rights reserved</p>
              </div>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 mb-6 sm:grid-cols-3 p-[64px, 165px, 64px, 165px]">
              <div>
              ...
              <div>
                  ...
                  <ul className="text-gray-500 dark:text-gray-400 font-medium">
                      <li className="mb-4">
                          <a href="https://github.com/themesberg/flowbite" className="hover:underline ">Terms of Service</a>
                      </li>
                      <li>
              ...
              <div className='' style={{fontFamily:"Gilroy"}}>
                  <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Stay up to Date</h2>
                  {/* <ul className="text-gray-500 dark:text-gray-400 font-medium">
                      <li className="mb-4">
